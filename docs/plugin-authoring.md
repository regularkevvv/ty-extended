...
- identity: `id`, `name`, and plugin `version`;
...
- capabilities: the semantic operations the plugin may perform;
...
[[plugins.plugin]]
id = "my-plugin"
path = ".ty/plugins/my_ty_plugin.wasm"
runtime = "wasm"
...
A plugin distributed with a Python library can place `ty-plugin.json` and its referenced WASM
